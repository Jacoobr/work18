...
def get_args():
    ...
    parser.add_argument('--exp', type=str, required=True)   # --exp <path_to_corresponding_experiment>, json file
    parser.add_argument('--reload', type=str, required=True)    # <path_to_checkpoint>
    parser.add_argument('--output_dir', type=str, default=None)     # <path_to_store_prediction>
