import sys
sys.path.append('/home/jacoob/workStation/polygonRNN++/polyrnnpp-pytorch/polyrnn-pp-pytorch/code/')
...
def get_args():
    ...
    # --exp point to: mle.json
    # --experiment_dir: output of training step, include logs
...
def get_data_loaders(opts, DataProvider):
    ...
    #num_workers: 8 threadings operation
...
class Trainer(object):
    ...
    def resume(self, path):
        ...
        self.optimizer.load_state_dict(save_state['optimizer'], map_location=lambda storage, loc: storage)
        self.lr_decay.load_state_dict(save_state['lr_decay'], map_location=lambda storage, loc: storage)
